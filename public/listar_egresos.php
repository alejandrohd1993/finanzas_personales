...
// Contar el total de egresos
$sql = "SELECT COUNT(*) as total FROM egresos WHERE usuario_id = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $_SESSION['user_id']);
$stmt->execute();
$result = $stmt->get_result();
$total_egresos = $result->fetch_assoc()['total'];

// Calcular el número total de páginas
$total_paginas = ceil($total_egresos / $items_por_pagina);
...
$sql = "SELECT * FROM egresos WHERE usuario_id = ? LIMIT ? OFFSET ?";
$stmt = $conn->prepare($sql);
